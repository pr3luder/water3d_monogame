...
technique TransformAndTextureDiffuse
{
    pass P0
    {
        vertexShader = compile vs_4_0_level_9_1 TransformDiffuse();
        pixelShader = compile ps_4_0_level_9_1 ApplyDiffuseTexture();
    }
}
...
technique TransformAndTextureDiffuseAndLightMap
{
    ...
    {
        vertexShader = compile vs_4_0_level_9_1 TransformDiffuse();
        pixelShader = compile ps_4_0_level_9_1 ApplyDiffuseLightMapTexture();
    }
}
