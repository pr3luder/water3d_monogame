// Shader: textures/sfx/metaltechfloor01final_bounce
// Generic Externs
uniform float4x4 worldViewProj;
uniform float gameTime;
// stage0's externs
uniform texture stage0_metaltechfloor01final_bounce;
...
{
	Texture = <stage0_metaltechfloor01final_bounce>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
float4 PixelShaderProgram(VertexShaderOutput input) : COLOR0
{
	...
	// stage0_metaltechfloor01final_bounce
