// Shader: textures/base_floor/clang_floorshiny2
// Generic Externs
...
// stage1's externs
uniform texture stage1_clang_floorshiny_alpha2;
...
{
	Texture = <stage1_clang_floorshiny_alpha2>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
float4 PixelShaderProgram(VertexShaderOutput input) : COLOR0
{
	...
	// stage1_clang_floorshiny_alpha2
