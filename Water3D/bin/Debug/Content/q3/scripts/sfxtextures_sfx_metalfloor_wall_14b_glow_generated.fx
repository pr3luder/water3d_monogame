// Shader: textures/sfx/metalfloor_wall_14b_glow
// Generic Externs
...
// stage1's externs
uniform texture stage1_metalfloor_wall_14b;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_metalfloor_wall_14bglow;
...
{
	Texture = <stage1_metalfloor_wall_14b>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage2_metalfloor_wall_14bglow>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
