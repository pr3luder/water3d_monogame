// Shader: textures/gothic_door/door02_i_ornate5_fin
// Generic Externs
...
// stage1's externs
uniform texture stage1_door02_i_ornate5_fin;
...
{
	Texture = <stage1_door02_i_ornate5_fin>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
