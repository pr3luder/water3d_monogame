...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage0.uv.x = s_stage0*cos(16.24902 * gameTime) + t_stage0 * -sin(16.24902 * gameTime) + (0.5 - 0.5 * cos(16.24902 * gameTime)+ 0.5 *sin(16.24902 * gameTime));
	output.stage0.uv.y = s_stage0*sin(16.24902 * gameTime) + t_stage0 * cos(16.24902 * gameTime) + (0.5 - 0.5 * sin(16.24902 * gameTime)- 0.5 *cos(16.24902 * gameTime));
