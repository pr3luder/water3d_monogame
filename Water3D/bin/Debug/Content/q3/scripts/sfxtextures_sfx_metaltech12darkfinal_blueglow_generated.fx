// Shader: textures/sfx/metaltech12darkfinal_blueglow
// Generic Externs
...
// stage1's externs
uniform texture stage1_metaltech12darkfinal;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_metaltech01blueglow;
...
{
	Texture = <stage1_metaltech12darkfinal>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage2_metaltech01blueglow>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
