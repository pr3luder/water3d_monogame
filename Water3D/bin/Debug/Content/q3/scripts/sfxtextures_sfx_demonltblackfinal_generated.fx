// Shader: textures/sfx/demonltblackfinal
// Generic Externs
...
// stage1's externs
uniform texture stage1_demonltblackfinal;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_demonltblackfinal_glow2;
...
{
	Texture = <stage1_demonltblackfinal>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage2_demonltblackfinal_glow2>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
