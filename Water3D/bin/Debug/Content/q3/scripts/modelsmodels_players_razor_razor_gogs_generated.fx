// Shader: models/players/razor/razor_gogs
// Generic Externs
uniform float4x4 worldViewProj;
uniform float gameTime;
// stage0's externs
uniform texture stage0_razor_gogs;
uniform float3x2 stage0_tcmod;
// stage1's externs
uniform texture stage1_razor_gogs_fx;
uniform float3x2 stage1_tcmod;

sampler stage0_sampler = sampler_state
{
	Texture = <stage0_razor_gogs>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage1.uv.x += 1.2 * gameTime;
	output.stage1.uv.y += 9.3 * gameTime;
