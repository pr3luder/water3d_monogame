// Shader: textures/base_light/sm_light1red
// Generic Externs
...
// stage1's externs
uniform texture stage1_sm_light1red;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_sm_light1red_blend;
...
{
	Texture = <stage2_sm_light1red_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
