// Shader: textures/eerie/pentagramfloor
// Generic Externs
...
// stage1's externs
uniform texture stage1_pentagramfloor;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_pentagramfloor_red_blend;
...
{
	Texture = <stage2_pentagramfloor_red_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
