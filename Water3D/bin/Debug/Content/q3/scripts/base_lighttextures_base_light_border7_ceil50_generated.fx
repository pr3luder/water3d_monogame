// Shader: textures/base_light/border7_ceil50
// Generic Externs
...
// stage1's externs
uniform texture stage1_border7_ceil50;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_border7_ceil50glow;
...
{
	Texture = <stage2_border7_ceil50glow>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
