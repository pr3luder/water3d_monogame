// Shader: textures/base_light/sm_light1blue
// Generic Externs
...
// stage1's externs
uniform texture stage1_sm_light1blue;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_sm_light1blue_blend;
...
{
	Texture = <stage2_sm_light1blue_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
