// Shader: textures/gothic_trim/km_arena1tower4_shiny
// Generic Externs
...
// stage1's externs
uniform texture stage1_km_arena1tower4_shiny;
...
{
	Texture = <stage1_km_arena1tower4_shiny>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
