...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage0.uv.x = s_stage0*cos(1.797689 * gameTime) + t_stage0 * -sin(1.797689 * gameTime) + (0.5 - 0.5 * cos(1.797689 * gameTime)+ 0.5 *sin(1.797689 * gameTime));
	output.stage0.uv.y = s_stage0*sin(1.797689 * gameTime) + t_stage0 * cos(1.797689 * gameTime) + (0.5 - 0.5 * sin(1.797689 * gameTime)- 0.5 *cos(1.797689 * gameTime));
	output.stage1.uv = input.texcoords;
	 float s_stage1 = output.stage1.uv.x;
	 float t_stage1 = output.stage1.uv.y;
	output.stage1.uv.x = s_stage1*cos(-3.141593 * gameTime) + t_stage1 * -sin(-3.141593 * gameTime) + (0.5 - 0.5 * cos(-3.141593 * gameTime)+ 0.5 *sin(-3.141593 * gameTime));
	output.stage1.uv.y = s_stage1*sin(-3.141593 * gameTime) + t_stage1 * cos(-3.141593 * gameTime) + (0.5 - 0.5 * sin(-3.141593 * gameTime)- 0.5 *cos(-3.141593 * gameTime));
