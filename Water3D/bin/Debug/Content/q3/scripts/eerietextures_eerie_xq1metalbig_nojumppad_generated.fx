// Shader: textures/eerie/xq1metalbig_nojumppad
// Generic Externs
...
// stage1's externs
uniform texture stage1_xq1metalbig_nojumppad;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_xq1metalbig_nojumppad_blend;
...
{
	Texture = <stage1_xq1metalbig_nojumppad>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage2_xq1metalbig_nojumppad_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
float4 PixelShaderProgram(VertexShaderOutput input) : COLOR0
{
	...
	// stage1_xq1metalbig_nojumppad
	destination = tex2D(stage1_sampler, input.stage1.uv) * destination;

	// stage2_xq1metalbig_nojumppad_blend
