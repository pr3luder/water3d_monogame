// Shader: models/players/slash/yurikoskate
// Generic Externs
...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage1.uv.x = s_stage1*cos(0.3490658 * gameTime) + t_stage1 * -sin(0.3490658 * gameTime) + (0.5 - 0.5 * cos(0.3490658 * gameTime)+ 0.5 *sin(0.3490658 * gameTime));
	output.stage1.uv.y = s_stage1*sin(0.3490658 * gameTime) + t_stage1 * cos(0.3490658 * gameTime) + (0.5 - 0.5 * sin(0.3490658 * gameTime)- 0.5 *cos(0.3490658 * gameTime));
