// Shader: textures/sfx/launchpad_metalbridge04d
// Generic Externs
...
// stage1's externs
uniform texture stage1_launchpad_metalbridge04d;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_launchpad_dot;
...
{
	Texture = <stage1_launchpad_metalbridge04d>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage3.uv.x += 0 * gameTime;
	output.stage3.uv.y += 2 * gameTime;
