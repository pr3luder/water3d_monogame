// Shader: textures/base_floor/tilefloor7_ow
// Generic Externs
...
// stage1's externs
uniform texture stage1_tilefloor7_ow;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_tilefloor7_owfx;
uniform float3x2 stage2_tcmod;
// stage3's externs
uniform texture stage3_tilefloor7_owfx;
...
{
	Texture = <stage2_tilefloor7_owfx>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage3_tilefloor7_owfx>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
