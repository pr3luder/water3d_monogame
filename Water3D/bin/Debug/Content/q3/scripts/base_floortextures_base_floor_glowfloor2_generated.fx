// Shader: textures/base_floor/glowfloor2
// Generic Externs
...
// stage1's externs
uniform texture stage1_metalfloor_wall_15;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_glowred1_blend;
...
{
	Texture = <stage1_metalfloor_wall_15>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
