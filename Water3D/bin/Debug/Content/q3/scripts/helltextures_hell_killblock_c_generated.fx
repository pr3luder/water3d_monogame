// Shader: textures/hell/killblock_c
// Generic Externs
...
// stage1's externs
uniform texture stage1_killblock_c;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_killblock_c_blend;
...
{
	Texture = <stage2_killblock_c_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
