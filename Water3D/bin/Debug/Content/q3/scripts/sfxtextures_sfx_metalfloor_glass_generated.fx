// Shader: textures/sfx/metalfloor_glass
// Generic Externs
uniform float4x4 worldViewProj;
uniform float gameTime;
// stage0's externs
uniform texture stage0_metalfloor_wall_15glass;
uniform float3x2 stage0_tcmod;
// stage1's externs
uniform texture stage1_metalfloor_wall_15glass;
uniform float3x2 stage1_tcmod;

sampler stage0_sampler = sampler_state
{
	Texture = <stage0_metalfloor_wall_15glass>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage1_metalfloor_wall_15glass>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
float4 PixelShaderProgram(VertexShaderOutput input) : COLOR0
{
	...
	// stage0_metalfloor_wall_15glass
	...
	// stage1_metalfloor_wall_15glass
