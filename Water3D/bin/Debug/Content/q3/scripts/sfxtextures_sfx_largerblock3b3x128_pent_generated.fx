// Shader: textures/sfx/largerblock3b3x128_pent
// Generic Externs
...
// stage1's externs
uniform texture stage1_largerblock3b3x128_pent;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_pentagramfloor_blue3glowtest;
...
{
	Texture = <stage1_largerblock3b3x128_pent>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage2_pentagramfloor_blue3glowtest>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
float4 PixelShaderProgram(VertexShaderOutput input) : COLOR0
{
	...
	// stage1_largerblock3b3x128_pent
	destination = tex2D(stage1_sampler, input.stage1.uv) * destination;

	// stage2_pentagramfloor_blue3glowtest
