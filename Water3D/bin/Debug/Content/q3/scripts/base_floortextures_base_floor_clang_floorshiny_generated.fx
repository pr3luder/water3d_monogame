// Shader: textures/base_floor/clang_floorshiny
// Generic Externs
...
// stage1's externs
uniform texture stage1_clang_floorshiny_alpha;
...
{
	Texture = <stage1_clang_floorshiny_alpha>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
