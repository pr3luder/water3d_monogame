...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage0.uv.x = s_stage0*cos(3.490659 * gameTime) + t_stage0 * -sin(3.490659 * gameTime) + (0.5 - 0.5 * cos(3.490659 * gameTime)+ 0.5 *sin(3.490659 * gameTime));
	output.stage0.uv.y = s_stage0*sin(3.490659 * gameTime) + t_stage0 * cos(3.490659 * gameTime) + (0.5 - 0.5 * sin(3.490659 * gameTime)- 0.5 *cos(3.490659 * gameTime));
	output.stage1.uv = input.texcoords;
	// Invalid or unparsed tcMod statement.
	 float s_stage1 = output.stage1.uv.x;
	 float t_stage1 = output.stage1.uv.y;
	output.stage1.uv.x = s_stage1*cos(1.22173 * gameTime) + t_stage1 * -sin(1.22173 * gameTime) + (0.5 - 0.5 * cos(1.22173 * gameTime)+ 0.5 *sin(1.22173 * gameTime));
	output.stage1.uv.y = s_stage1*sin(1.22173 * gameTime) + t_stage1 * cos(1.22173 * gameTime) + (0.5 - 0.5 * sin(1.22173 * gameTime)- 0.5 *cos(1.22173 * gameTime));
	output.stage2.uv = input.texcoords;
	// Invalid or unparsed tcMod statement.
	 float s_stage2 = output.stage2.uv.x;
	 float t_stage2 = output.stage2.uv.y;
	output.stage2.uv.x = s_stage2*cos(0.8726646 * gameTime) + t_stage2 * -sin(0.8726646 * gameTime) + (0.5 - 0.5 * cos(0.8726646 * gameTime)+ 0.5 *sin(0.8726646 * gameTime));
	output.stage2.uv.y = s_stage2*sin(0.8726646 * gameTime) + t_stage2 * cos(0.8726646 * gameTime) + (0.5 - 0.5 * sin(0.8726646 * gameTime)- 0.5 *cos(0.8726646 * gameTime));
	output.stage3.uv = input.texcoords;
	// Invalid or unparsed tcMod statement.
	 float s_stage3 = output.stage3.uv.x;
	 float t_stage3 = output.stage3.uv.y;
	output.stage3.uv.x = s_stage3*cos(0.5235988 * gameTime) + t_stage3 * -sin(0.5235988 * gameTime) + (0.5 - 0.5 * cos(0.5235988 * gameTime)+ 0.5 *sin(0.5235988 * gameTime));
	output.stage3.uv.y = s_stage3*sin(0.5235988 * gameTime) + t_stage3 * cos(0.5235988 * gameTime) + (0.5 - 0.5 * sin(0.5235988 * gameTime)- 0.5 *cos(0.5235988 * gameTime));
