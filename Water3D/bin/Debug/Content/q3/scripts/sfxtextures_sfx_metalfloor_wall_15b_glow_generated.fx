// Shader: textures/sfx/metalfloor_wall_15b_glow
// Generic Externs
...
// stage1's externs
uniform texture stage1_metalfloor_wall_15b;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_metalfloor_wall_15bglow;
...
{
	Texture = <stage1_metalfloor_wall_15b>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage2_metalfloor_wall_15bglow>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
