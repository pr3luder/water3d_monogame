// Shader: textures/sfx/goopq1metal7_98dnodamage
// Generic Externs
uniform float4x4 worldViewProj;
uniform float gameTime;
// stage0's externs
uniform texture stage0_goopq1metal7_98dnodamage;
...
{
	Texture = <stage0_goopq1metal7_98dnodamage>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
float4 PixelShaderProgram(VertexShaderOutput input) : COLOR0
{
	...
	// stage0_goopq1metal7_98dnodamage
