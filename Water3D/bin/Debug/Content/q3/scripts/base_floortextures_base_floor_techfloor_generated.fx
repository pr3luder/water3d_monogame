// Shader: textures/base_floor/techfloor
// Generic Externs
...
// stage2's externs
uniform texture stage2_techfloor;
...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage1.uv.x = s_stage1*cos(2.96706 * gameTime) + t_stage1 * -sin(2.96706 * gameTime) + (0.5 - 0.5 * cos(2.96706 * gameTime)+ 0.5 *sin(2.96706 * gameTime));
	output.stage1.uv.y = s_stage1*sin(2.96706 * gameTime) + t_stage1 * cos(2.96706 * gameTime) + (0.5 - 0.5 * sin(2.96706 * gameTime)- 0.5 *cos(2.96706 * gameTime));
