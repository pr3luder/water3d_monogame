// Shader: textures/base_light/proto_lightgreen
// Generic Externs
...
// stage1's externs
uniform texture stage1_proto_lightgreen;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_proto_lightgreen;
...
{
	Texture = <stage1_proto_lightgreen>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage2_proto_lightgreen>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
