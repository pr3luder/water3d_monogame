// Shader: textures/eerie/tesla_cable
// Generic Externs
...
// stage1's externs
uniform texture stage1_tesla_cable;
...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage2.uv.x += 1 - sin(((((input.position.x + input.position.z) * 0.001 + (0.1 * gameTime))) % 1025) * 6.283185) * 0.2;
	output.stage2.uv.y += 1 - sin(((((input.position.y) * 0.001 + (0.1 * gameTime))) % 1025) * 6.283185) * 0.2;
	output.stage2.uv.x += 0 * gameTime;
	output.stage2.uv.y += 15 * gameTime;
