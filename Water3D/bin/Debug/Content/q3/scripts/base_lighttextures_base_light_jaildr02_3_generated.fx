// Shader: textures/base_light/jaildr02_3
// Generic Externs
...
// stage1's externs
uniform texture stage1_jaildr02_3;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_jaildr02_3_blend;
...
{
	Texture = <stage2_jaildr02_3_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
