// Shader: textures/sfx/metaltechfloor02final_pent
// Generic Externs
uniform float4x4 worldViewProj;
uniform float gameTime;
// stage0's externs
uniform texture stage0_metaltechfloor02final_pent;
...
{
	Texture = <stage0_metaltechfloor02final_pent>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
float4 PixelShaderProgram(VertexShaderOutput input) : COLOR0
{
	...
	// stage0_metaltechfloor02final_pent
