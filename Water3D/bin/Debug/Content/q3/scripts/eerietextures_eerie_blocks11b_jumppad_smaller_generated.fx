// Shader: textures/eerie/blocks11b_jumppad_smaller
// Generic Externs
...
// stage1's externs
uniform texture stage1_blocks11b_jumppad_smaller;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_jumppad_smaller;
...
{
	Texture = <stage1_blocks11b_jumppad_smaller>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage2_jumppad_smaller>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
