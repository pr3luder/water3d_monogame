// Shader: textures/base_trim/skull_monitor
// Generic Externs
uniform float4x4 worldViewProj;
uniform float gameTime;
// stage0's externs
uniform texture stage0_skull_monitor;
uniform float3x2 stage0_tcmod;
// stage1's externs
uniform texture stage1_text;
...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage0.uv.x += 1 - sin(((((input.position.x + input.position.z) * 0.001 + (0.2 * gameTime))) % 1025) * 6.283185) * 0.05;
	output.stage0.uv.y += 1 - sin(((((input.position.y) * 0.001 + (0.2 * gameTime))) % 1025) * 6.283185) * 0.05;
