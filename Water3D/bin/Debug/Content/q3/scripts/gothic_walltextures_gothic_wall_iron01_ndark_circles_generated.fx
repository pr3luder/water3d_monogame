// Shader: textures/gothic_wall/iron01_ndark_circles
// Generic Externs
...
// stage1's externs
uniform texture stage1_iron01_ndark_circles;
...
{
	Texture = <stage1_iron01_ndark_circles>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
