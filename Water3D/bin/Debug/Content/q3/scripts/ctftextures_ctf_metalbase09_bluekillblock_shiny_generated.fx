// Shader: textures/ctf/metalbase09_bluekillblock_shiny
// Generic Externs
...
// stage1's externs
uniform texture stage1_metalbase09_bluekillblock;
...
{
	Texture = <stage1_metalbase09_bluekillblock>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
float4 PixelShaderProgram(VertexShaderOutput input) : COLOR0
{
	...
	// stage1_metalbase09_bluekillblock
