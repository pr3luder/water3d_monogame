// Shader: models/powerups/ammo/lighammo1
// Generic Externs
...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage0.uv.x = s_stage0*cos(0.1047198 * gameTime) + t_stage0 * -sin(0.1047198 * gameTime) + (0.5 - 0.5 * cos(0.1047198 * gameTime)+ 0.5 *sin(0.1047198 * gameTime));
	output.stage0.uv.y = s_stage0*sin(0.1047198 * gameTime) + t_stage0 * cos(0.1047198 * gameTime) + (0.5 - 0.5 * sin(0.1047198 * gameTime)- 0.5 *cos(0.1047198 * gameTime));
	output.stage0.uv.x += 0.09 * gameTime;
