// Shader: textures/eerie/lavahell
// Generic Externs
...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage0.uv.x += 1 - sin(((((input.position.x + input.position.z) * 0.001 + (0.09 * gameTime))) % 1025) * 6.283185) * 0.4;
	output.stage0.uv.y += 1 - sin(((((input.position.y) * 0.001 + (0.09 * gameTime))) % 1025) * 6.283185) * 0.4;
