...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage0.uv.x = s_stage0*cos(0.3490658 * gameTime) + t_stage0 * -sin(0.3490658 * gameTime) + (0.5 - 0.5 * cos(0.3490658 * gameTime)+ 0.5 *sin(0.3490658 * gameTime));
	output.stage0.uv.y = s_stage0*sin(0.3490658 * gameTime) + t_stage0 * cos(0.3490658 * gameTime) + (0.5 - 0.5 * sin(0.3490658 * gameTime)- 0.5 *cos(0.3490658 * gameTime));
	output.stage1.uv = input.texcoords;
	 float s_stage1 = output.stage1.uv.x;
	 float t_stage1 = output.stage1.uv.y;
	output.stage1.uv.x = s_stage1*cos(-6.981317 * gameTime) + t_stage1 * -sin(-6.981317 * gameTime) + (0.5 - 0.5 * cos(-6.981317 * gameTime)+ 0.5 *sin(-6.981317 * gameTime));
	output.stage1.uv.y = s_stage1*sin(-6.981317 * gameTime) + t_stage1 * cos(-6.981317 * gameTime) + (0.5 - 0.5 * sin(-6.981317 * gameTime)- 0.5 *cos(-6.981317 * gameTime));
	output.stage2.uv = input.texcoords;
	 float s_stage2 = output.stage2.uv.x;
	 float t_stage2 = output.stage2.uv.y;
	output.stage2.uv.x = s_stage2*cos(0.6981317 * gameTime) + t_stage2 * -sin(0.6981317 * gameTime) + (0.5 - 0.5 * cos(0.6981317 * gameTime)+ 0.5 *sin(0.6981317 * gameTime));
	output.stage2.uv.y = s_stage2*sin(0.6981317 * gameTime) + t_stage2 * cos(0.6981317 * gameTime) + (0.5 - 0.5 * sin(0.6981317 * gameTime)- 0.5 *cos(0.6981317 * gameTime));
