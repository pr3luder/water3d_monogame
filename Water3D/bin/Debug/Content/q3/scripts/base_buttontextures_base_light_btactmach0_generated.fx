// Shader: textures/base_light/btactmach0
// Generic Externs
...
// stage1's externs
uniform texture stage1_btactmach0;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_btactmach0_blend;
...
{
	Texture = <stage2_btactmach0_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
