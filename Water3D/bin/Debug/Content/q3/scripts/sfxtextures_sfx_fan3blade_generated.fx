...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage0.uv.x = s_stage0*cos(1.570796 * gameTime) + t_stage0 * -sin(1.570796 * gameTime) + (0.5 - 0.5 * cos(1.570796 * gameTime)+ 0.5 *sin(1.570796 * gameTime));
	output.stage0.uv.y = s_stage0*sin(1.570796 * gameTime) + t_stage0 * cos(1.570796 * gameTime) + (0.5 - 0.5 * sin(1.570796 * gameTime)- 0.5 *cos(1.570796 * gameTime));
