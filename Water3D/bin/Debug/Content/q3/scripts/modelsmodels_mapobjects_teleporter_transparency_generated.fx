// Shader: models/mapobjects/teleporter/transparency
// Generic Externs
uniform float4x4 worldViewProj;
uniform float gameTime;
// stage0's externs
uniform texture stage0_transparency;
uniform float3x2 stage0_tcmod;
// stage1's externs
uniform texture stage1_transparency2;
uniform float3x2 stage1_tcmod;

sampler stage0_sampler = sampler_state
{
	Texture = <stage0_transparency>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
