// Shader: textures/sfx/hellfog_mini_dm10
// Generic Externs
uniform float4x4 worldViewProj;
uniform float gameTime;
// stage0's externs
uniform texture stage0_kc_fogcloud3;
uniform float3x2 stage0_tcmod;
// stage1's externs
uniform texture stage1_kc_fogcloud3;
uniform float3x2 stage1_tcmod;

sampler stage0_sampler = sampler_state
{
	Texture = <stage0_kc_fogcloud3>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage1.uv.x *= 20;
	output.stage1.uv.y *= 20;
