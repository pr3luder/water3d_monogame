// Shader: textures/gothic_wall/window_evil7
// Generic Externs
...
// stage1's externs
uniform texture stage1_window_evil7;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_window_evil7_glow;
...
{
	Texture = <stage2_window_evil7_glow>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
