// Shader: textures/base_light/wsupprt1_12
// Generic Externs
...
// stage1's externs
uniform texture stage1_wsupprt1_12;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_wsupprt1_12_blend;
...
{
	Texture = <stage2_wsupprt1_12_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
