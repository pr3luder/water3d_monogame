// Shader: textures/base_light/light2blue_2500
// Generic Externs
...
// stage1's externs
uniform texture stage1_light1blue;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_light1blue1_blend;
...
{
	Texture = <stage2_light1blue1_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
