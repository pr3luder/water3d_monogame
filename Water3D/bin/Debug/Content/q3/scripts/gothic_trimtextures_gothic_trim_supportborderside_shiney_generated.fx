// Shader: textures/gothic_trim/supportborderside_shiney
// Generic Externs
...
// stage1's externs
uniform texture stage1_xsupportborderside_shiney;
...
{
	Texture = <stage1_xsupportborderside_shiney>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
float4 PixelShaderProgram(VertexShaderOutput input) : COLOR0
{
	...
	// stage1_xsupportborderside_shiney
