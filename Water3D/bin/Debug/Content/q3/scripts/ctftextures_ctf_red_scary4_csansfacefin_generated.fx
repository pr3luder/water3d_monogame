// Shader: textures/ctf/red_scary4_csansfacefin
// Generic Externs
...
// stage1's externs
uniform texture stage1_red_scary4_csansfacefin;
...
{
	Texture = <stage1_red_scary4_csansfacefin>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
float4 PixelShaderProgram(VertexShaderOutput input) : COLOR0
{
	...
	// stage1_red_scary4_csansfacefin
