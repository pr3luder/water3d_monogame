// Shader: textures/base_light/patch10_pj_lite
// Generic Externs
...
// stage1's externs
uniform texture stage1_patch10_pj_lite;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_patch10_pj_lite_blend;
...
{
	Texture = <stage1_patch10_pj_lite>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage2_patch10_pj_lite_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
