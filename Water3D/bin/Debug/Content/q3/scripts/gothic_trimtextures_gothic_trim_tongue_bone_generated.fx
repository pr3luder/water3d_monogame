// Shader: textures/gothic_trim/tongue_bone
// Generic Externs
...
// stage1's externs
uniform texture stage1_tongue_bone;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_tongue_bone_blend;
...
{
	Texture = <stage2_tongue_bone_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
