// Shader: textures/eerie/firewall
// Generic Externs
uniform float4x4 worldViewProj;
uniform float gameTime;
// stage0's externs
uniform texture stage0_firewalla;
uniform float3x2 stage0_tcmod;
// stage1's externs
uniform texture stage1_firewallb;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_firewall;
uniform float3x2 stage2_tcmod;

sampler stage0_sampler = sampler_state
{
	Texture = <stage0_firewalla>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage2.uv.y += 40 * gameTime;
