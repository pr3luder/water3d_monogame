// Shader: textures/sfx/metalfloor_wall_5_glow
// Generic Externs
...
// stage1's externs
uniform texture stage1_metalfloor_wall_5;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_metalfloor_wall_5_glow;
...
{
	Texture = <stage1_metalfloor_wall_5>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage2_metalfloor_wall_5_glow>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
