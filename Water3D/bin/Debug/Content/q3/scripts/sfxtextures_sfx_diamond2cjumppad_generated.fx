// Shader: textures/sfx/diamond2cjumppad
// Generic Externs
uniform float4x4 worldViewProj;
uniform float gameTime;
// stage0's externs
uniform texture stage0_bouncepad01_diamond2cTGA;
...
{
	Texture = <stage0_bouncepad01_diamond2cTGA>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
float4 PixelShaderProgram(VertexShaderOutput input) : COLOR0
{
	...
	// stage0_bouncepad01_diamond2cTGA
