// Shader: models/flags/b_flag2
// Generic Externs
uniform float4x4 worldViewProj;
uniform float gameTime;
// stage0's externs
uniform texture stage0_b_flag2;
uniform float3x2 stage0_tcmod;
// stage1's externs
uniform texture stage1_blue_fx;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_b_flag2;
uniform float3x2 stage2_tcmod;
// stage3's externs
uniform texture stage3_shadow;
uniform float3x2 stage3_tcmod;

sampler stage0_sampler = sampler_state
{
	Texture = <stage0_b_flag2>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
