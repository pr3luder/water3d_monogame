// Shader: textures/gothic_trim/metalsupport4h_shiny
// Generic Externs
...
// stage1's externs
uniform texture stage1_metalsupport4h_shiny;
...
{
	Texture = <stage1_metalsupport4h_shiny>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
