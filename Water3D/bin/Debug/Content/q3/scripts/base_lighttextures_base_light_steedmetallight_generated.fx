// Shader: textures/base_light/steedmetallight
// Generic Externs
...
// stage1's externs
uniform texture stage1_steedmetallight;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_steedmetallight_blend;
...
{
	Texture = <stage1_steedmetallight>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage2_steedmetallight_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
