// Shader: textures/gothic_trim/metlsupport4i_shiney
// Generic Externs
...
// stage1's externs
uniform texture stage1_xmetalsupport4i_alpha;
...
{
	Texture = <stage1_xmetalsupport4i_alpha>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
