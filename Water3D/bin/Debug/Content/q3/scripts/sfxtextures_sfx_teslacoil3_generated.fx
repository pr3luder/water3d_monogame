// Shader: textures/sfx/teslacoil3
// Generic Externs
uniform float4x4 worldViewProj;
uniform float gameTime;
// stage0's externs
uniform texture stage0_cabletest2;
uniform float3x2 stage0_tcmod;
// stage1's externs
uniform texture stage1_electricslime2;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_tesla1b;
uniform float3x2 stage2_tcmod;

sampler stage0_sampler = sampler_state
{
	Texture = <stage0_cabletest2>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
