// Shader: textures/eerie/surface6jumppad
// Generic Externs
...
// stage1's externs
uniform texture stage1_surface6;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_surface6jumppad_blend;
...
{
	Texture = <stage2_surface6jumppad_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
