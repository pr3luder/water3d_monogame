// Shader: textures/base_light/wsupprt1_12h
// Generic Externs
...
// stage1's externs
uniform texture stage1_wsupprt1_12h;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_wsupprt1_12h_blend;
...
{
	Texture = <stage2_wsupprt1_12h_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
