// Shader: textures/sfx/goopq1metal7_98darrow
// Generic Externs
...
// stage1's externs
uniform texture stage1_goopq1metal7_98dlarge;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_pitted_rust3arrow_blend;
...
{
	Texture = <stage1_goopq1metal7_98dlarge>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
...
{
	Texture = <stage2_pitted_rust3arrow_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
