// Shader: textures/gothic_wall/xpipecolumn_gray_shiny
// Generic Externs
...
// stage1's externs
uniform texture stage1_xpipecolumn_gray_shiny;
...
{
	Texture = <stage1_xpipecolumn_gray_shiny>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
