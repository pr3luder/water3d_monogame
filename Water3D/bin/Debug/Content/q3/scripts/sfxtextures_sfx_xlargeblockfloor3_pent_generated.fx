// Shader: textures/sfx/xlargeblockfloor3_pent
// Generic Externs
...
// stage1's externs
uniform texture stage1_xlargeblockfloor3_pent;
...
{
	Texture = <stage1_xlargeblockfloor3_pent>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
