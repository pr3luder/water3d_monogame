// Shader: textures/base_floor/cybergrate3
// Generic Externs
...
// stage1's externs
uniform texture stage1_cybergrate3;
...
VertexShaderOutput VertexShaderProgram(VertexShaderInput input)
{
	...
	output.stage0.uv.x *= 0.8333333;
	output.stage0.uv.y *= 2;
	output.stage0.uv.x += 3.1 * gameTime;
	output.stage0.uv.y += 1.1 * gameTime;
