// Shader: textures/base_light/jaildr03_2
// Generic Externs
...
// stage1's externs
uniform texture stage1_jaildr03_2;
uniform float3x2 stage1_tcmod;
// stage2's externs
uniform texture stage2_jaildr03_2_blend;
...
{
	Texture = <stage2_jaildr03_2_blend>;
	minfilter = LINEAR;
	magfilter = LINEAR;
	mipfilter = NONE;
	AddressU = Wrap;
