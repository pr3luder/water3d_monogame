...
namespace Water3D
{
    ...
    public abstract class ParticleSystem : Object3D
    {
        ...
        void RetireActiveParticles()
        {
            ...
            float particleDuration = effectContainer.getEffect().Parameters["Duration"].GetValueSingle();
        ...
        public override void setRenderStates()
        {
            ...
            scene.Game.GraphicsDevice.BlendState = settings.BlendState;
            scene.Game.GraphicsDevice.DepthStencilState = DepthStencilState.DepthRead;

        }

        /// <summary>
        /// Helper for resetting the renderstates used to draw particles.
        /// </summary>
        public override void resetRenderStates()
        {
            scene.Game.GraphicsDevice.BlendState = BlendState.AlphaBlend;
